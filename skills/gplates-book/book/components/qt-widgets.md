...
| [ChooseColourButton](../src/qt-widgets/ChooseColourButton.md) | 2 | 165 | 33 | Swatch button showing a colour, opens a picker with alpha on click |
...
| [ChooseFeatureCollectionWidget](../src/qt-widgets/ChooseFeatureCollectionWidget.md) | 2 | 542 | 100 | Reusable list control for picking or creating a feature collection |
...
| [ConfigureExportParametersDialog](../src/qt-widgets/ConfigureExportParametersDialog.md) | 2 | 1008 | 45 | Dialog for adding one export type/format/options entry to an animation export |
...
| Unit | Tier | Lines | Fan-in | Description |
|---|---|---|---|---|
| [CreateFeatureAddOrEditPropertyDialog](../src/qt-widgets/CreateFeatureAddOrEditPropertyDialog.md) | 2 | 721 | 22 | Modal dialog for adding or editing one feature property via a GPGIM-driven edit widget |
| [CreateFeatureDialog](../src/qt-widgets/CreateFeatureDialog.md) | 2 | 3446 | 43 | Multi-page wizard for digitising a new feature (and optional conjugate) from geometry |
...
| [CreateSmallCircleDialog](../src/qt-widgets/CreateSmallCircleDialog.md) | 2 | 910 | 14 | Dialog for adding single or ranged small circles to a SmallCircleWidget |
...
| Unit | Tier | Lines | Fan-in | Description |
|---|---|---|---|---|
| [EditAffineTransformGeoreferencingWidget](../src/qt-widgets/EditAffineTransformGeoreferencingWidget.md) | 2 | 1213 | 19 | Edits a raster's Georeferencing as lat/lon extents or a full affine transform |
...
| [EditGeometryWidget](../src/qt-widgets/EditGeometryWidget.md) | 2 | 1557 | 113 | Table-based editor for point/line/multi-point/polygon geometry properties, one row per vertex |
...
| [EditTableActionWidget](../src/qt-widgets/EditTableActionWidget.md) | 2 | 258 | 70 | Per-row insert/delete button toolbar embedded as a QTableWidget cell widget |
...
| [EditTimePeriodWidget](../src/qt-widgets/EditTimePeriodWidget.md) | 2 | 722 | 13 | AbstractEditWidget for editing a GmlTimePeriod's begin/end time-of-appearance and disappearance |
...
| [EditTotalReconstructionSequenceWidget](../src/qt-widgets/EditTotalReconstructionSequenceWidget.md) | 2 | 1620 | 12 | Table editor for a total reconstruction sequence's GpmlIrregularSampling of rotation poles |
...
| [EditWidgetGroupBox](../src/qt-widgets/EditWidgetGroupBox.md) | 2 | 1268 | 64 | Hub of pre-allocated per-type edit widgets, showing whichever one matches the property being edited |

#### Export

| Unit | Tier | Lines | Fan-in | Description |
|---|---|---|---|---|
| [ExportAnimationDialog](../src/qt-widgets/ExportAnimationDialog.md) | 2 | 2044 | 15 | Dialog for queuing and running animation-sequence and single-snapshot exports |
...
| [ExportOptionsWidget](../src/qt-widgets/ExportOptionsWidget.md) | 2 | 68 | 56 | Abstract base for the per-export-type option panels shown in the export configuration dialogs |
...
| [HellingerThread](../src/qt-widgets/HellingerThread.md) | 2 | 448 | 39 | Background QThread that runs the Hellinger pole-fitting Python scripts |
...
| [KinematicGraphsConfigurationWidget](../src/qt-widgets/KinematicGraphsConfigurationWidget.md) | 2 | 442 | 27 | Settings form for kinematic-graph time step and velocity warning thresholds/method |
| [KinematicGraphsDialog](../src/qt-widgets/KinematicGraphsDialog.md) | 2 | 2040 | 38 | The Kinematics Tool dialog: computes and plots velocity/rotation graphs over time |

#### Manage

| Unit | Tier | Lines | Fan-in | Description |
|---|---|---|---|---|
| [ManageFeatureCollectionsActionWidget](../src/qt-widgets/ManageFeatureCollectionsActionWidget.md) | 2 | 486 | 36 | Per-file action bar (save/reload/unload/edit) row in the Manage Feature Collections table |
| [ManageFeatureCollectionsDialog](../src/qt-widgets/ManageFeatureCollectionsDialog.md) | 2 | 1746 | 17 | Manage Feature Collections window: table of loaded files with per-row load/save actions |
...
| Unit | Tier | Lines | Fan-in | Description |
|---|---|---|---|---|
| [OpenDirectoryDialog](../src/qt-widgets/OpenDirectoryDialog.md) | 2 | 130 | 19 | Wraps QFileDialog::getExistingDirectory, remembering the last directory via ViewState |
| [OpenFileDialog](../src/qt-widgets/OpenFileDialog.md) | 2 | 203 | 45 | Wraps QFileDialog::getOpenFileName(s), remembering a per-purpose last-used directory |
...
| [ReconstructionViewWidget](../src/qt-widgets/ReconstructionViewWidget.md) | 2 | 1019 | 180 | Central widget wiring the globe/map canvas, toolbars and TaskPanel into ViewportWindow's layout |
...
| Unit | Tier | Lines | Fan-in | Description |
|---|---|---|---|---|
| [SetCameraViewpointDialog](../src/qt-widgets/SetCameraViewpointDialog.md) | 2 | 260 | 149 | Fixed-size dialog for typing an explicit camera latitude/longitude |
...
| [ShapefileAttributeWidget](../src/qt-widgets/ShapefileAttributeWidget.md) | 2 | 786 | 11 | Maps shapefile attribute columns onto GPlates model properties via combo boxes |
...
| [TopologyToolsWidget](../src/qt-widgets/TopologyToolsWidget.md) | 2 | 1326 | 13 | Task-panel form for building/editing topological features, delegating to TopologyTools |

#### Visual

| Unit | Tier | Lines | Fan-in | Description |
|---|---|---|---|---|
| [VisualLayerWidget](../src/qt-widgets/VisualLayerWidget.md) | 2 | 2230 | 18 | One reusable row of the Layers panel, repointed at a different VisualLayer per set\_data |
...
| [AgeModelManagerDialog](../src/qt-widgets/AgeModelManagerDialog.md) | 3 | 527 | 0 | Manager dialog for geological timescale models |
| [AnimateControlWidget](../src/qt-widgets/AnimateControlWidget.md) | 3 | 577 | 1 | Playback controls for geological time animation |
| [AnimateDialog](../src/qt-widgets/AnimateDialog.md) | 3 | 973 | 0 | Configuration dialog for geological time animations |
| [ApplyReconstructionPoleAdjustmentDialog](../src/qt-widgets/ApplyReconstructionPoleAdjustmentDialog.md) | 2 | 1321 | 35 | Dialog and applicator for manually adjusting a reconstruction pole |
| [AssignReconstructionPlateIdsDialog](../src/qt-widgets/AssignReconstructionPlateIdsDialog.md) | 2 | 2426 | 22 | Wizard dialog for assigning plate ids by partitioning against polygon layers |
| [CalculateReconstructionPoleDialog](../src/qt-widgets/CalculateReconstructionPoleDialog.md) | 3 | 628 | 0 | Dialog for computing plate rotation from a Virtual Geomagnetic Pole |
| [CanvasToolBarDockWidget](../src/qt-widgets/CanvasToolBarDockWidget.md) | 3 | 2326 | 4 | Tabbed toolbar organizing canvas tools by editing workflow |
...
| [ColourScaleButton](../src/qt-widgets/ColourScaleButton.md) | 2 | 384 | 155 | Button previewing a raster colour palette as an unannotated scale image |
...
| [DrawStyleDialog](../src/qt-widgets/DrawStyleDialog.md) | 2 | 1656 | 7 | Dialog for choosing, editing and live-previewing a layer's or all layers' draw style |
...
| [FileDialogFilter](../src/qt-widgets/FileDialogFilter.md) | 2 | 152 | 22 | Value type describing one file dialog filter entry (description plus extensions) |
...
| [FriendlyLineEdit](../src/qt-widgets/FriendlyLineEdit.md) | 2 | 468 | 70 | QLineEdit wrapper that shows a grey italic placeholder message when logically empty |
...
| [GPlatesDialog](../src/qt-widgets/GPlatesDialog.md) | 2 | 137 | 344 | Base class for major GPlates dialogs, adding parent-required construction and pop\_up() |
| [GlobeAndMapWidget](../src/qt-widgets/GlobeAndMapWidget.md) | 2 | 842 | 53 | Hosts the globe and map canvases in a stacked layout, switching between them on projection change |
| [GlobeCanvas](../src/qt-widgets/GlobeCanvas.md) | 2 | 2425 | 53 | QGLWidget rendering the 3D globe and turning mouse/keyboard input into canvas-tool events |
...
| [ImportRasterDialog](../src/qt-widgets/ImportRasterDialog.md) | 2 | 1064 | 45 | Wizard that imports one or more raster files into a GPML raster feature collection |
| [ImportScalarField3DDialog](../src/qt-widgets/ImportScalarField3DDialog.md) | 2 | 994 | 50 | Wizard that builds a 3D scalar field feature from a stack of depth-layer rasters |
| [InformationDialog](../src/qt-widgets/InformationDialog.md) | 2 | 238 | 92 | Minimal read-only text pop-up used across dialogs to show a short explanatory note |
...
| [LayerOptionsWidget](../src/qt-widgets/LayerOptionsWidget.md) | 2 | 75 | 58 | Abstract base for the per-visual-layer-type options panel shown in the layers list |
...
| [LinkWidget](../src/qt-widgets/LinkWidget.md) | 2 | 236 | 20 | Clickable hyperlink-styled label used inside layer-options widgets |
...
| [MapView](../src/qt-widgets/MapView.md) | 2 | 1389 | 42 | QGraphicsView/QGLWidget map view sharing OpenGL context with the globe canvas |
...
| [ModifyReconstructionPoleWidget](../src/qt-widgets/ModifyReconstructionPoleWidget.md) | 2 | 1788 | 23 | Task panel for the Manipulate Pole tool: drags geometry to build a candidate rotation adjustment |
| [MovePoleWidget](../src/qt-widgets/MovePoleWidget.md) | 2 | 1090 | 22 | Task panel widget owning the adjustment pole for the Move Pole canvas tool |
...
| [ProgressDialog](../src/qt-widgets/ProgressDialog.md) | 2 | 211 | 474 | Reusable modal progress bar with cooperative cancellation, pumping the event loop each update |
...
| [QtWidgetUtils](../src/qt-widgets/QtWidgetUtils.md) | 2 | 284 | 278 | Grab-bag of Qt dialog/widget helper functions shared across the module's dialogs |
...
| [ReadErrorAccumulationDialog](../src/qt-widgets/ReadErrorAccumulationDialog.md) | 2 | 897 | 13 | Displays accumulated file-read errors/warnings grouped by type and by file/line |
...
| [SaveFileDialog](../src/qt-widgets/SaveFileDialog.md) | 2 | 261 | 65 | Cross-platform save-file dialog wrapping the native or Qt file picker |
...
| [SelectionWidget](../src/qt-widgets/SelectionWidget.md) | 2 | 466 | 37 | Single-choice widget unifying QListWidget and QComboBox behind one API |
| [SmallCircleWidget](../src/qt-widgets/SmallCircleWidget.md) | 2 | 601 | 43 | TaskPanel widget backing the Create Small Circle canvas tool |
...
| [TaskPanel](../src/qt-widgets/TaskPanel.md) | 2 | 1047 | 18 | Stacked-widget task panel hosting one TaskPanelWidget per canvas-tool workflow |
| [TaskPanelWidget](../src/qt-widgets/TaskPanelWidget.md) | 2 | 107 | 23 | Abstract base for widgets shown as a TaskPanel tab |
...
| [TotalReconstructionSequencesDialog](../src/qt-widgets/TotalReconstructionSequencesDialog.md) | 2 | 2844 | 170 | Tree editor over loaded .rot files: sequences, poles, plate-ID filtering |
