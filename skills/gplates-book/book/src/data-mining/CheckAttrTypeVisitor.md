...
[Book TOC](../../TOC.md) · [data-mining](../../components/data-mining.md) · cluster Community 1404 · tier 2

| Source file | Kind | Lines |
|---|---|---|
| `src/data-mining/CheckAttrTypeVisitor.h` | C++ | 294 |
...
|---|---|---|---|---|---|
| [`GPlatesDataMining::AttributeTypeEnum`](#gplatesdataminingattributetypeenum) | enum | — | — | 0 | — |
| [`GPlatesDataMining::CheckAttrTypeVisitor`](#gplatesdataminingcheckattrtypevisitor) | class | [`GPlatesModel::ConstFeatureVisitor`](../model/FeatureVisitor.md) | — | 0 | TODO |

## Members

### `GPlatesDataMining::AttributeTypeEnum`

| Member | Kind | Type | Access | Description |
|---|---|---|---|---|
| `Unknown_Type` | enumerator | `None` | — | — |
| `Number_Attribute` | enumerator | `None` | — | — |
| `String_Attribute` | enumerator | `None` | — | — |

### `GPlatesDataMining::CheckAttrTypeVisitor`

| Member | Kind | Type | Access | Description |
|---|---|---|---|---|
| `CheckAttrTypeVisitor()` | constructor | `None` | public | — |
...
| `type()` | method | `AttributeTypeEnum` | public | — |
| `d_type` | field | `AttributeTypeEnum` | protected | — |
| `d_map` | field | `std::multimap< QString, GPlatesDataMining::AttributeTypeEnum >` | protected | — |

## Free functions and macros

| Name | Kind | Type / body | Description |
|---|---|---|---|
| `GPLATESDATAMINING_CHECKATTRTYPEVISITOR_H` | macro | `None` | — |
...
|---|---|---|
| [qt-widgets/CoRegistrationLayerConfigurationDialog](../qt-widgets/CoRegistrationLayerConfigurationDialog.md) | qt-widgets | 59 |
...
```bash
python scripts/gpq.py file src/data-mining/CheckAttrTypeVisitor.h
python scripts/gpq.py def GPlatesDataMining::CheckAttrTypeVisitor --body
python scripts/gpq.py uses CheckAttrTypeVisitor --kind class
python scripts/gpq.py hier CheckAttrTypeVisitor
```
