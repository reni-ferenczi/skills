...
Exception thrown when the system cannot execute the gzip command to decompress GPML files on-the-fly during reading. Captures both the command that was attempted and the filename of the file that triggered the failure for error reporting.
